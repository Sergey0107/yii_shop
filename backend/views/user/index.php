        ...
        <div class="modal-dialog modal-dialog-centered cosmic-modal">
            <div class="modal-content cosmic-modal-content">
                <div class="modal-header cosmic-modal-header">
                    <h5 class="modal-title cosmic-modal-title" id="userModalLabel">Добавить пользователя</h5>
...
$this->registerJs(<<<JS
$(document).on('click', '[data-bs-toggle="modal"][data-bs-target="#userModal"]', function(e) {
    e.preventDefault();
    ...
    $('#userModalLabel').text(isUpdate ? 'Редактировать пользователя' : 'Добавить пользователя');
});
